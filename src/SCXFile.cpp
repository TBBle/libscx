...
// Everything below here is XOR'd against: 0xa9 0xb3 0xf2 0x87 0xdc 0xaf 0x13
0x67 0xd5 0x91 0xec
...
bool SCXFile::read(string fileName) {
    ...
    */
    ...
    if (!read_fixed_data<0x40, 0x0c>(
            variables_, buffer, variable_strings_offset, variable_blobs_offset))
        return false;
