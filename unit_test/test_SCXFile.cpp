...
TEST_CASE("Load the original avking SCX file") {
  ...
  const string scene14500Text =
	  ...
	  u8"[\\c,2,829][\\c,3,829]"
	  u8"「うむ、無沙汰をしておったな、轟よ。渡したⅰポットンは役に立っておるのか"
	  u8"？」[\\r]"
	  u8"[\\c,3,15]"
	  u8"「もっちろんですよ〜これさえあれば、どんな危険な任務もらっくらくって感じ"
	  u8"〜」[\\r]"
	  u8"[\\c,3,829]"
	  u8"「ふむ、ならば良い。それより今日はそなたに尋ねたいことがあるのじゃ」["
	  u8"\\r]"
	  u8"[\\c,3,15]"
	  u8"「僕にですかぁ〜？　光栄だなぁ〜。なんでも聞いてくださいよ〜」["
	  u8"\\r]"
	  u8"[\\c,3,829]「うむ。では尋ねるが…轟はＳＭというものを知っておるか？」["
	  u8"\\r]"
	  u8"[\\c,0,723][\\c,3,723]"
	  u8"「えええＳＭううう〜！？　なな、なんでそんなことを？」[\\r]"
	  u8"[\\c,3,829]"
	  u8"「うむ。実はちと仕事の為に資料が必要になっての。ＳＭについて調べておるの"
	  u8"じゃ」[\\r]"
	  u8"[\\c,3,723]「は、はぁ…仕事の為ですか…びっくりしたぁ〜…」[\\r]"
	  u8"[\\c,3,829]「それよりどうなのじゃ？　知っておるのか、いないのか？」[\\r]"
	  u8"[\\c,0,724][\\c,3,724]"
	  u8"「あ、え〜とですねぇ、僕より詳しい専門家がいるんで、その人に聞くのがいい"
	  u8"かとぉ」[\\r]"
